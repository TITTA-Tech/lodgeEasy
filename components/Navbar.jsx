...
export default function Navbar() {
  ...
  return (
    <nav className="relative w-full h-auto py-3 px-5 flex justify-between md:justify-start items-center ">
      ...
      <div
        className={`absolute top-12 right-0 z-50 md:static p-5 md:p-0 md:opacity-[1!important] md:translate-x-0 h-[80vh] md:h-auto w-screen md-w-auto bg-white shadow-md md:shadow-none md:bg-transparent transition-all duration-1000 ${
